...
<h1 align="center" style="font-size: 50px;">Welcome to ShutDownNet project 👋</h1>

# ✨ ShutDownNet

>#### Shutdown a computer of your network by writing it ID (can combine with ScanAllNet)bash
...
**WINDOWS:** Simply click twice on `ShutDownNet.pyw` or run using IDLE

**LINUX:** Not tested yet for GUIs
```bash
python3 ShutDownNet.pyw
```
